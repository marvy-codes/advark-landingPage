      ...
      >
        ...
        <div class="">
          <img
            ...
            class="absolute top-0 -z-40 h-screen md:left-0 md:-ml-[40px]"
          />
          <img
            src="../assets/background.png"
            class="absolute top-0 right-0 -z-40 mr-[0px] hidden h-screen md:block"
          />
        </div>
        ...
        <div class="mx-auto">
          ...
          <p class="mt-[14px] mb-[14px]">
            ...
            and Aardvark Technologies LLC ("Company", “we”, “us”, or “our”),
            concerning your access to and use of the obsidianqa.com website as
            ...
            Terms of Use, including the Terms of Service posted on the Site,
            which are incorporated into these Terms of Use. IF YOU DO NOT AGREE
          ...
          <h2
            class="mt-[20px] mb-[14px] text-center text-[24px] font-semibold leading-[24px] text-[#ffffffde] md:text-left md:leading-[40px]"
          >
          ...
          <p class="mt-[14px] mb-[14px]">
            7. Interfere with, disrupt, or create an undue burden on the Site or
            the networks or services connected to the Site.
          </p>
          <p class="mt-[14px] mb-[14px]">
            8. Attempt to impersonate another user or person or use the username
            of another user.
          </p>
          <p class="mt-[14px] mb-[14px]">
            9. Use any information obtained from the Site in order to harass,
            abuse, or harm another person.
          </p>
          <p class="mt-[14px] mb-[14px]">
            10. Use the Site as part of any effort to compete with us or
            otherwise use the Site and/or the Content for any revenue-generating
            endeavor or commercial enterprise.
          </p>
          <p class="mt-[14px] mb-[14px]">
            11. Decipher, decompile, disassemble, or reverse engineer any of the
            software comprising or in any way making up a part of the Site.
          </p>
          <p class="mt-[14px] mb-[14px]">
            12. Attempt to bypass any measures of the Site designed to prevent
          ...
          <p class="mt-[14px] mb-[14px]">
            14. Delete the copyright or other proprietary rights notice from any
            Content.
          </p>
          <p class="mt-[14px] mb-[14px]">
            15. Copy or adapt the Site’s software, including but not limited to
            Flash, PHP, HTML, JavaScript, or other code.
          </p>
          <p class="mt-[14px] mb-[14px]">
            16. Upload or transmit (or attempt to upload or to transmit)
          ...
          <p class="mt-[14px] mb-[14px]">
            17. Upload or transmit (or attempt to upload or to transmit) any
          ...
          <p class="mt-[14px] mb-[14px]">
            19. Disparage, tarnish, or otherwise harm, in our opinion, us and/or
            the Site.
          </p>
          <p class="mt-[14px] mb-[14px]">
            20. Use the Site in a manner inconsistent with any applicable laws
            or regulations.
          </p>
          ...
          <p class="mt-[14px] mb-[14px]">
            ...
            Policy: https://aardvark.sh/privacy. By using the Site, you agree to
            ...
            States. If you access the Site from any other region of the world
          ...
          <p class="mt-[14px] mb-[14px]">Informal Negotiations</p>
          <p class="mt-[14px] mb-[14px]">
          ...
          <p class="mt-[14px] mb-[14px]">Binding Arbitration</p>
          <p class="mt-[14px] mb-[14px]">
            ...
            applicable law, the arbitration will take place in Spokane,
            Washington. Except as otherwise provided herein, the Parties may
          ...
          <p class="mt-[14px] mb-[14px]">
            ...
            state and federal courts located in Spokane, Washington, and the
          ...
          <p class="mt-[14px] mb-[14px]">Restrictions</p>
          <p class="mt-[14px] mb-[14px]">
