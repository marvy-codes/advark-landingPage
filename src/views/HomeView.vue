  ...
  <div>
    <PageLayout>
      ...
      <div>
        ...
        <div
          class="relative mx-auto mt-[168px] w-[340px] text-center sm:w-[650px] md:mt-[240px] md:w-[700px] lg:w-[1100px] lg:pl-10 lg:scale-90"
        >
            ...
            >
              ...
              <span class="mr-[-28px] sm:mr-[0px]"
                ><img
                  ...
                  class="mx-[15px] inline h-[48px] w-[48px] lg:h-[80px] lg:w-[80px]"
                />freedom of</span
              >
              decentralized
              <div
              ...
              >
                ...
                <img
                  ...
                  class="inline h-[48px] w-[48px] lg:h-[80px] lg:w-[80px]"
                />
              </div>
            </h1>
          </div>
